...
class Productor(threading.Thread):
    def __init__(self,listaObjetos, lista = listaFinita):
        super().__init__()
        self.lista = lista
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                if numeraco == 0:
                    numeraco = 1
                    self.lista.append(self.listaObjetos[random.randint(0,len(self.listaObjetos)-1)])
                    logging.info(f'produjo el pais/capital: {self.lista[-1]}')
...
def main():
    hilos = []
    lista = listaFinita(4)
    listaPaises = [("España", "Madrid"), ("Francia", "Paris"), ("Italia", "Roma"), ("Inglaterra", "Londres"),
                   ("Alemania", "Berlin"), ("Rusia", "Moscu"),
                   ("Turquia", "Istambul"), ("China", "Pekin"), ("Japon", "Tokio"), ("Emiratos Arabes", "Dubai"),
                   ("Argentina", "Buenos Aires"),
                   ("Brasil", "Brasilia"), ("Colombia", "Bogota"), ("Uruguay", "Montevideo")]


    for i in range(4):
        productor = Productor(listaPaises,lista)
